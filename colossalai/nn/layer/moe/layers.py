...
from colossalai.nn.layer.moe.experts import SparseMLP, get_expert_class
...
class MoeLayer(nn.Module):
    ...
    def __init__(self, dim_model: int, num_experts: int, router: MoeRouter, experts: SparseMLP):
        super().__init__()
        self.d_model = dim_model
        self.num_experts = num_experts
        self.gate_weight = torch.nn.Parameter(torch.empty(num_experts, dim_model))
        self.router: MoeRouter = router
        self.experts: SparseMLP = experts
